...
//    • Sending messages and streaming the response token by token
//    • Resetting the model and clearing the conversation
//    • The content filter (Obadeki)
//
//  To change the AI's personality → edit SystemPrompt.swift
// ──────────────────────────────────────────────────────────────────────────────
...
class ChatViewModel: ObservableObject {
    ...
    private func loadModel() async {
        ...
        do {
            ...
            session = ChatSession(container, instructions: AIPersonality.systemPrompt, generateParameters: params)
            isReady = true
        } catch {
